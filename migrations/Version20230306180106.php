 ...
 */
final class Version20230306180106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cancion (id INT AUTO_INCREMENT NOT NULL, disco_id INT DEFAULT NULL, titulo VARCHAR(255) NOT NULL, duracion DATETIME NOT NULL, letra LONGTEXT DEFAULT NULL, INDEX IDX_E4620FA086CCF19B (disco_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
